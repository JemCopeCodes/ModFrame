...
public class SpriteRenderTexture : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            SetSprite(true);
            _curGameObject = PreviewGenerator.GameObjectToRender;
        }
    }
    ...
    void Update()
    {
        if (_previewGeneratorComponent != null)
        {
            ...
            SetSprite((_curGameObject != PreviewGenerator.GameObjectToRender) || _previewGeneratorComponent.renderTextureChanged);
        }
    }
